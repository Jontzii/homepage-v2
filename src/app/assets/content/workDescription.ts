  ...
  return {
    work: {
      vincit: {
        ...
        years: "2022-present",
        description: [
          "I am working with a team planning, researching, and developing proof-of-concept software for a client in the e-sports industry.",
          "- Researching and utilising multiple different e-sports data feed APIs",
          "- Software will utilise machine learning and generative AI",
          "\n",
          "I am developing Vincit's internal payroller software, which our salary team uses to calculate the correct bonuses, provisions, and other benefits for workers.",
          "- Integrations with multiple other systems used by the salary team",
          "\n",
          "Previously, I worked for a well-known company in the energy sector as a contractor, developing a customer information system (CIS) used by many of Finland's largest energy companies.",
