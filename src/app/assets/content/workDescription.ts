  ...
  return {
    work: {
      vincit: {
        ...
        years: "2022-present",
        description: [
          "I am working as a senior full-stack developer in a fast-paced hospitality project to create a new website, a custom booking engine and a new services website for a prominent Finnish hospitality chain.",
